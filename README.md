<img vspace="10" hspace="10" align="right" width="200" height="200" src="/images/sloomba.jpeg">
I am an [EPSRC Doctoral Prize Fellow](https://www.ukri.org/what-we-offer/developing-people-and-skills/epsrc/studentships/flexibility-for-funders/epsrc-doctoral-prize/) in the [Department of Mathematics](https://www.imperial.ac.uk/mathematics) at [Imperial College London](https://www.imperial.ac.uk/). I completed my PhD in Applied Mathematics supervised by [Prof. Nick S. Jones](https://www.imperial.ac.uk/people/nick.jones) in the [Systems and Signals](https://systems-signals.blogspot.com/) group at [Imperial College London](https://www.imperial.ac.uk/) and [Dr. Sumeet Agarwal](http://web.iitd.ac.in/~sumeet/research.html) at [IIT Delhi](http://www.iitd.ac.in/). I study how people form social connections, and how social networks relate to their health, which involves research at the crossroads of network science, sociology and public health. In particular, I develop mathematical methods to infer the structure and statistics of large-scale social networks. My talks at [Networks 2021](https://youtu.be/tRbz1FhhK6U) and [Sunbelt 2020](https://youtu.be/etw-rDI0-Uw), and poster presented at [IC2S2](/docs/pdf_sashealth.pdf), captures some of my research on these topics. I also collaborate with the [Vaccine Confidence Project](https://www.vaccineconfidence.org/) at [LSHTM](https://www.lshtm.ac.uk/) and [Social-Decision Making Lab](https://www.sdmlab.psychol.cam.ac.uk/) at [Cambridge](https://www.cam.ac.uk/) to study [misinformation and its impact on the COVID-19 pandemic](https://www.nature.com/articles/s41562-021-01056-1).
